package com.example.mutiphotochoser.fragment;
...
import com.example.mutiphotochoser.R;
import com.example.mutiphotochoser.adapter.ImageGridAdapter;
...
import com.example.mutiphotochoser.widget.HeaderGridView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View contentView = inflater.inflate(
				R.layout.fragment_image_grid_layout, null);
		imageGridView = (HeaderGridView) contentView
				.findViewById(R.id.gridGallery);
		int numColumns = (getResources().getDisplayMetrics().widthPixels - DisplayUtils
				.dip2px(6, getActivity()))
				/ DisplayUtils.dip2px(116, getActivity());
		...
		LayoutParams lp = new LayoutParams(LayoutParams.WRAP_CONTENT,
				DisplayUtils.dip2px(82, getActivity()));
