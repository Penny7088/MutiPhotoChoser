package com.example.mutiphotochoser.adapter;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			ImageLoader.getInstance().displayImage(
					"file://" + mDatas.get(position).getPath(),
					holder.imgQueue, options);
			if (mDatas.get(position).isSeleted()) {
				holder.imgQueueMultiSelected
						.setImageResource(R.drawable.image_check_on);
				holder.layerView
						.setBackgroundResource(R.color.image_selected_color);
			} else {
				holder.imgQueueMultiSelected
						.setImageResource(R.drawable.image_check_off);
